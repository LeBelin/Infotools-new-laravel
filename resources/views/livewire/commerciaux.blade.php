...
<div>
    ...
    <!-- Modal supression du commercial -->
    ...
    <flux:modal name="show-commercial" class="min-w-[22rem]">
        <div class="space-y-6">
            @if($showCommercial)
                <div class="space-y-4">
                    <flux:heading size="lg">Informations du commercial</flux:heading>
                        ...
                        <table class="w-full text-sm text-left">
                            <tbody class="divide-y divide-gray-100">
                                <tr>
                                    ...
                                    <td class="px-4 py-2">{{ $showCommercial->nom }}</td>
                                </tr>
                                <tr>
                                    <th class="px-4 py-2 font-medium text-gray-600">Email</th>
                                    <td class="px-4 py-2">{{ $showCommercial->email }}</td>
                                </tr>
                                <tr>
                                    <th class="px-4 py-2 font-medium text-gray-600">Téléphone</th>
                                    <td class="px-4 py-2">{{ $showCommercial->telephone }}</td>
                                </tr>
                                <tr>
                                    <th class="px-4 py-2 font-medium text-gray-600">Adresse</th>
                                    <td class="px-4 py-2">{{ $showCommercial->adresse }}</td>
                                </tr>
                                <tr>
                                    <th class="px-4 py-2 font-medium text-gray-600">Créé le</th>
                                    <td class="px-4 py-2">{{ $showCommercial->created_at->format('d/m/Y à H:i') }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            @else
                <p class="text-center text-gray-500">Commercial introuvable.</p>
            @endif
                    ...
                    <tr class="odd:bg-white even:bg-gray-50 border-b dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <td class="px-6 py-2">
                            ...
                            <flux:button icon:trailing="chevron-down" variant="primary">Options</flux:button>
                                ...
                                <flux:menu>
                                    <flux:menu.item icon="search" kbd="👀" wire:click="show({{ $commercial->id }})">Voir</flux:menu.item>
